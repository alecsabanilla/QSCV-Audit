...
export const AREA_OWNERS = [
  ...
  {email:"ronna.gamoso@tenya.com.ph",        name:"Ronna Gamoso",
   branches:["Tenya Express Market! Market!","Tenya Express Mitsukoshi","Tenya SM Southmall",
             "Tenya Festival Mall","Tenya Glorietta 2","Tenya Tiendesitas","Tenya Paseo De Magallanes"]}
];
